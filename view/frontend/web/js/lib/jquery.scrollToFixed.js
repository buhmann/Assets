...
define([
    ...
    $.ScrollToFixed = function(el, options) {
        ...
        function checkWork() {
            return $(window).width() > base.options.minWidth
                    && (!base.options.maxWidth || ($(window).width() <= base.options.maxWidth))
                    && !base.options.stopAction();
        }
        ...
        let windowResize = function(event) {
